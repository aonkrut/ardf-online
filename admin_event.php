...
<div class="container mt-2">
    ...
    ?>
        ...
        <form action="action.php" method="get">
                ...
                <input type="hidden" name="event_id" value="<?php echo $event_id; ?>">
                <button type="submit" class="btn btn-success">Stvori novo natjecanje</button>
            </form>
                        ...
                        <h5 class="mb-0">Natjecanje <b><?php echo $row['competition_name']; ?></b></h5>
                            <ul class="list-group list-group-flush">
                                ...
                                <!--
                                    ...
                                    <span><strong>// echo $row['competition_fee']; </strong></span>
                                </li>
                            -->
                            </ul>
                            
                            <button type="button" class="btn btn-primary mt-2" onclick="editCompetition(<?php echo $competition_id; ?>)">
                                Uredi
                            </button>
                            <a href="action.php?remove_from_event=<?php echo $competition_id; ?>&event_id=<?php echo $event_id; ?>"  class="card-link btn btn-danger mt-2">Ukloni</a>
                        </div>
                    </div>
                    <?php
                }
